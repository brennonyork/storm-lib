...
import org.brennonyork.siren.BatchMutation;
 ...
 * @author Brennon York
 */
public class BatchMutationTopology {
    ...
    void BatchMutationTopology() { }

    public static void main(String[] args) {
	BatchMutationTopology bmt = new BatchMutationTopology();
	bmt.run(args);
    }
}
